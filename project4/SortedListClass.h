...
// The sorted list class does not store any data directly.  Instead, it contains
// a collection of LinkedNodeClass objects, each of which contains one element.
class SortedListClass
{
  ...
  public:
    ...
    // that location.
    bool getElemAtIndex(const int index, int &outVal);
};
